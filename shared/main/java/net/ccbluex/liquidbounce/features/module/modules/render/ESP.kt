...
class ESP : Module() {
    @JvmField
    val modeValue = ListValue("Mode", arrayOf("BigGod","Box", "OtherBox", "WireFrame", "2D", "Real2D", "Outline", "ShaderOutline", "ShaderGlow"), "Box")
                ...
                when (mode.toLowerCase()) {
                    ...
                    "biggod" ->{
                                ...
                                GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f)
                                    ...
                                    RenderUtils.drawImage(classProvider.createResourceLocation("pride/sweatsoy.png"), (-8.0).toInt(), (-14.0).toInt(), 16, 16)
                                GL11.glPopMatrix()
                                GL11.glPopMatrix()
