...
class ScoreboardElement(x: Double = 5.0, y: Double = 0.0, scale: Float = 1F,
    ...
    override fun drawElement(): Border? {
        ...
        RenderUtils.drawRoundRect(l1 - 2F, -2F, 5F, ((maxHeight + fontRenderer.fontHeight).toFloat()),6F, backColor)
//        RenderUtils.drawShadowWithCustomAlpha(l1 -F , -2F, 95F, ((maxHeight + fontRenderer.fontHeight).toFloat()),200F)
